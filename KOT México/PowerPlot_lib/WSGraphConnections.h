...
@interface WSGraphConnections : WSObject <NSCopying, NSCoding, NSFastEnumeration> {

    NSMutableSet *_connections;
    id <WSDataDelegate> _dataDelegate;
}

@property (retain) NSMutableSet *connections;                   ///< Connections of objects in a WSData object.
@property (assign, nonatomic) id <WSDataDelegate> dataDelegate; ///< Data delegate for nodes.
