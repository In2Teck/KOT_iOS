...
+ (WSData *)demoGraphNodes {
    ...
    NSString *graphLabels[7] = {@"Customer", @"Product", @"Marketing", @"Development", @"Competition", @"Customization", @"Operation" };
    
    return [WSData dataWithValues:[WSData arrayWithFloat:graphSetY withLen:7]
                      withValuesX:[WSData arrayWithFloat:graphSetX withLen:7]
                  withAnnotations:[WSData arrayWithString:graphLabels withLen:7]];    
}
...
+ (WSData *)electionResults2009 {
    ...
    NSString *parties[6] = {@"CDU", @"FDP", @"SPD", @"Green", @"The Left", @"Others"};

    return [WSData dataWithValues:[WSData arrayWithFloat:election
                                                 withLen:6]
                  withAnnotations:[NSArray arrayWithObjects:parties
                                                      count:6]];
}
...
+ (WSData *)scientificData {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:dataSet2D withLen:7]
                      withValuesX:[WSData arrayWithFloat:dataSet3D withLen:7]
                    withErrorMinY:[WSData arrayWithFloat:dataSet4D withLen:7]
                    withErrorMaxY:[NSArray array]
                    withErrorMinX:[WSData arrayWithFloat:dataSet4D withLen:7]
                    withErrorMaxX:[WSData arrayWithFloat:dataSet5D withLen:7]];
}
...
+ (WSData *)failedBanks {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:failures withLen:11]
                      withValuesX:[WSData arrayWithFloat:years withLen:11]];
}
...
+ (NSArray *)sixMonths {
    ...
    return [WSData arrayWithString:months withLen:6];
}

+ (WSData *)monthlyHits {
    float hits[6] = {68824, 85378, 119482, 77549, 66987, 86501};

    WSData *tmp = [WSData dataWithValues:[WSData arrayWithFloat:hits withLen:6]
                         withAnnotations:[self sixMonths]];
...
+ (WSData *)monthlyPageviews {
    ...
    WSData *tmp = [WSData dataWithValues:[WSData arrayWithFloat:views withLen:6]
                         withAnnotations:[self sixMonths]];
...
+ (WSData *)monthlyVisitors {
    ...
    WSData *tmp = [WSData dataWithValues:[WSData arrayWithFloat:sessions withLen:6]
                         withAnnotations:[self sixMonths]];
...
+ (WSData *)scatteredPoints {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:valY withLen:100]
                      withValuesX:[WSData arrayWithFloat:valX withLen:100]];
}
...
+ (WSData *)centerRegion {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:valY withLen:50]
                      withValuesX:[WSData arrayWithFloat:valX withLen:50]];
}
...
+ (WSData *)formFactorMeasured {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:valY withLen:18]
                      withValuesX:[WSData arrayWithFloat:valX withLen:18]
                    withErrorMinY:[WSData arrayWithFloat:valYErr withLen:18]
                    withErrorMaxY:[WSData data]
                    withErrorMinX:[WSData data]
                    withErrorMaxX:[WSData data]];
}
...
+ (WSData *)formFactorFit {
    ...
    return [WSData dataWithValues:[WSData arrayWithFloat:valY withLen:10]
                      withValuesX:[WSData arrayWithFloat:valX withLen:10]
                    withErrorMinY:[WSData arrayWithFloat:valYErr withLen:10]
                    withErrorMaxY:[WSData data]
                    withErrorMinX:[WSData data]
                    withErrorMaxX:[WSData data]];    
}
...
+ (WSData *)stocks3 {
    float rates[5] = {150.5,100.8, 90.2, 70.7, 50.3};
    WSData *result = [WSData dataWithValues:[WSData arrayWithFloat:rates
                                                           withLen:5]];
...
+ (void)sineFunctionWithData:(WSData *)data
    ...
    for (CGFloat x=xmin; x<xmax+step; x+=step) {
        [data addData:[WSDatum datumWithValue:(offset+factor*sin(x+phase))
                                   withValueX:x]];
    }
}
